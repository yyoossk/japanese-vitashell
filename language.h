...
language_container_t language_japanese = {  
  ...
  L"PSNの偽装を有効",
  L"安全ではない自作アプリを有効",
  L"悪意が含まれていたり誤って設定されていた場合、危険な自作アプリはあなたのデバイスを永久的に破壊する事が出来ます。\nインストールをする時は注意して下さい",
  L"バージョンの偽装を有効",
  L"偽装するバージョン",
  L"○ボタンの動作設定",
  L"決定",
  L"キャンセル",
  L"taiHEN config.txtの再読込",
  L"taiHEN config.txtの再読込が完了しました。",
  L"端末の再起動",
  L"コンテンツダウンローダー",
  L"メモリーカードと接続を解除",
  L"ux0のid.datが削除しまた。このメモリーカードは他のVitaでも使用可能となりました",
  L"uux0との接続に失敗しました。メモリーカードは挿入されていますか？",
};
