...
static MenuEntry about_entries[] = {
  ...
  { "", MENU_ENTRY_TYPE_TEXT, WHITE, NULL, NULL, NULL, 0 },
  { "製作者", MENU_ENTRY_TYPE_TEXT, ORANGE, NULL, NULL, NULL, 0 },
  ...
  { "f.lux:Rinnegatamante", MENU_ENTRY_TYPE_TEXT, WHITE, NULL, NULL, NULL, 0 },
  { "vita2dlib:xerpi", MENU_ENTRY_TYPE_TEXT, WHITE, NULL, NULL, NULL, 0 },
};

static TabEntry tab_entries[] = {
  { "メイン", main_entries, sizeof(main_entries) / sizeof(MenuEntry), 1 },
  { "ステータス", NULL, 0, 0 },
  { "設定", settings_entries, sizeof(settings_entries) / sizeof(MenuEntry), 1 },
  { "詳細", about_entries, sizeof(about_entries) / sizeof(MenuEntry), 0 },
};
